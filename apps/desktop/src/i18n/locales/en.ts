...
export default {
  ...
  ai: {
    ...
    ccSwitchProviderDescription: "Optional CC-SWITCH plugin. Selecting this entry does not download anything; the plugin is downloaded and installed only after you click an install button.",
    ...
    ccSwitchPluginInstall: "Install CC-SWITCH plugin",
    ccSwitchPluginInstalling: "Installing...",
    ccSwitchPluginInstallLocal: "Install from local ZIP",
    ccSwitchPluginUninstall: "Uninstall plugin",
    ccSwitchPluginInstallSuccess: "CC-SWITCH plugin installed",
    ccSwitchPluginInstallFailed: "Failed to install CC-SWITCH plugin: {message}",
    ccSwitchPluginUninstallSuccess: "CC-SWITCH plugin uninstalled",
    ccSwitchPluginUninstallFailed: "Failed to uninstall CC-SWITCH plugin: {message}",
