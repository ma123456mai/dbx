...
export default withEnglishFallback({
  ...
  ai: {
    ...
    ccSwitchProviderDescription: "可选的 CC-SWITCH 插件。选择此项不会自动下载，点击安装按钮后才会下载并安装插件。",
    ...
    ccSwitchPluginInstall: "安装 CC-SWITCH 插件",
    ccSwitchPluginInstalling: "安装中...",
    ccSwitchPluginInstallLocal: "从本地 ZIP 安装",
    ccSwitchPluginUninstall: "卸载插件",
    ccSwitchPluginInstallSuccess: "CC-SWITCH 插件已安装",
    ccSwitchPluginInstallFailed: "CC-SWITCH 插件安装失败：{message}",
    ccSwitchPluginUninstallSuccess: "CC-SWITCH 插件已卸载",
    ccSwitchPluginUninstallFailed: "CC-SWITCH 插件卸载失败：{message}",
