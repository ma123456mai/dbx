...
export const ccSwitchPluginStatus = forward("ccSwitchPluginStatus");
export const installCcSwitchPlugin = forward("installCcSwitchPlugin");
export const installCcSwitchPluginLocal = forward("installCcSwitchPluginLocal");
export const uninstallCcSwitchPlugin = forward("uninstallCcSwitchPlugin");
