...
pub use manifest::{
    ...
    PluginCapabilityManifest, PluginConnectionCapability, PluginConnectionProviderContribution, PluginContribution,
    PluginDriverManifest,
...
impl PluginRegistry {
        ...
        T: DeserializeOwned,
    {
        ...
        let result = session
            .invoke_with_timeout(method, params, Some(capability_id), Some(PLUGIN_REQUEST_TIMEOUT))
            .await;
