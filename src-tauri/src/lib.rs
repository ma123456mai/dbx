...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cc_switch::cc_switch_plugin_status,
            commands::cc_switch::install_cc_switch_plugin,
            commands::cc_switch::install_cc_switch_plugin_local,
            commands::cc_switch::uninstall_cc_switch_plugin,
